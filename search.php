            ...
            <aside class="blog-right-sidebar">
                ...
                <div class="bento-box" style="padding: 20px;">
                    <form role="search" method="get" style="position: relative;" action="<?php echo esc_url(home_url('/')); ?>">
                        ...
                        <input type="search" name="s" placeholder="Cari artikel..." value="<?php echo get_search_query(); ?>" style="width: 100%; padding: 12px 15px 12px 45px; border: 1px solid #eaeaea; border-radius: 12px; outline: none; font-size: 0.95rem; background: #f8f9fa; transition: all 0.2s;" onfocus="this.style.background='#fff'; this.style.borderColor='#007bff'" onblur="this.style.background='#f8f9fa'; this.style.borderColor='#eaeaea'" />
                    </form>
                </div>
